...
const CategorieSingleMain = (singleData) => {
    ...
    console.log("Formations dans la catégorie:", formationsInCategory);
                                ...
                                <div key={index} className="col-xl-4 col-lg-4 col-md-6">
                                    <div className="services__two-single-service">
                                        ...
                                        <div className="services__two-single-service-image">
                                            <img className="img__full" src={formation.image?.src} alt={formation?.titl} />
                                        </div>
                                        <div className="services__two-single-service-content formation-solution">
                                            <h4>{formation.title}</h4> {/* Titre de la formation */}
                                            <Link 
